    ...
    const fallbackComics = [
        {
            ...
            genres: ["Action", "Fantasy", "Adventure", "Supernatural", "Webtoon", "Martial Arts", "Romance"],
            summary: "Di dunia di mana para pemburu dengan kekuatan magis melindungi umat manusia dari makhluk-makhluk berbahaya, seorang pemburu kelas terendah bernama Sung Jin-Woo menemukan dirinya terjebak dalam sebuah dungeon yang mematikan. Setelah hampir kehilangan nyawanya, ia mendapatkan kemampuan unik yang memungkinkannya untuk menjadi lebih kuat dengan mengalahkan musuh-musuhnya. Dengan tekad untuk melindungi orang-orang yang dicintainya dan mengungkap misteri di balik kekuatannya, Sung Jin-Woo memulai perjalanan epiknya sebagai pemburu terkuat di dunia.",
            chapterTemplate: {
                count: 4,
                order: "desc",
                titlePattern: "Chapter {number}: Petualangan Baru",
                idPattern: "Solo-Leveling-chapter-{number}",
                pagePattern: "https://placehold.co/920x1280/24130f/f8dfc5.png?text=Solo%20Leveling%0AChapter%20{chapter}%0APage%20{page}",
                pageStart: 1,
                pageEnd: 7,
                pagePad: 2,
